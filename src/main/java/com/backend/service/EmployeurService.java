...
// ==================== SEARCH METHODS ====================
    ...
    @Transactional
    public List<EtudiantDTO> searchEtudiants(String searchTerm) throws UtilisateurPasTrouveException {
    ...
    @Transactional
    public List<ProfesseurDTO> searchProfesseursList(String searchTerm) throws UtilisateurPasTrouveException {
    ...
    @Transactional
    public List<GestionnaireDTO> searchGestionnaires(String searchTerm) throws UtilisateurPasTrouveException {
    ...
    @Transactional
    public List<EmployeurDTO> searchEmployeurs(String searchTerm) throws UtilisateurPasTrouveException {
