...
const DashBoardEmployeur = () => {
    ...
    useEffect(() => {
        ...
        // Récupérer le nom complet de l'utilisateur (comme dans DashBoardEtudiant)
        try {
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="mt-3 text-sm text-gray-600 dark:text-slate-300 flex flex-col gap-2">
                                                ...
                                                {conv.etudiantPrenom && conv.etudiantNom && (
                                                    <div className="flex items-center gap-2">
                                                        <span className="text-xs uppercase tracking-wide text-gray-500 dark:text-slate-400">{t('employerdashboard:convocations.student') || 'Etudiant'}</span>
                                                        <span className="text-sm text-gray-700 dark:text-slate-200 font-medium truncate">{conv.etudiantPrenom} {conv.etudiantNom}</span>
                                                    </div>
                                                )}
