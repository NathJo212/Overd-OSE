...
const LanguageSelector = () => {
    ...
    return (
        <div className="flex items-center gap-2 bg-white/95 backdrop-blur-md rounded-lg px-3 py-2 shadow-lg border border-gray-200/50 hover:shadow-xl transition-all duration-300">
